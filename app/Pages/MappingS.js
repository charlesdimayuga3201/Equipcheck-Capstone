...
import S_FDC_1st_2P from "./S_Mapping/S_FDC_1st_2P";
import S_FDC_2nd_1P from "./S_Mapping/S_FDC_2nd_1P";
import S_FDC_2nd_2P from "./S_Mapping/S_FDC_2nd_2P";
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.modalContainerA}>
          <View style={styles.modalContentA}>
            ...
            <Image
              source={require("../assets/images/s_bg1.png")}
              resizeMode="contain"
              style={styles.image1}
            />
          </View>
      ...
      <ScrollView>
        ...
        <View style={styles.group1}>
          ...
          {MselectedFloor === "1st Floor P2" && MselectedBuilding === "FDC" && (
            //Mapping Content//
            <S_FDC_1st_2P
              isModalVisible={isModalVisible}
              hideModal={hideModal}
